--Readme document for Keira Wong, keiralw@uci.edu--
...
- I don't believe there was anything special needed to run the code, however I did exclude a very large 'git' file (that took around 11GB) when zipping, as the file was too large otherwise. However, when I opened the zip file all the .html/.css files I worked on were present.